...
?>
      ...
      <nav class="navbar navbar-inverse">
          <div class="navbar-header">
              ...
              <ul class="nav navbar-nav">
                  <li><a href="home_salaryRegular.php">Regular Employee</a></li>
                  <li class="active"><a href="home_salaryCasual.php">Casual Employee</a></li>
  ...
  <div class="row">
      <div class="col-md-12">
          <h1 class="page-head-line">Casual Employee Salary</h1>
                        ...
                        <table class="table table-bordered table-hover table-condensed" id="myTable">
                            ...
                            include("calculations/regularCalculation.php");
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        <a class="btn btn-warning" href="edit_casualAccount.php?emp_id=<?php echo $row2["emp_id"]; ?>">Modify</a>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-sm-8">
                            <select  class="form-control" id="emp_id" style=" height:35px;" name="emp_id" onchange="myFunction(this.value)">
                              ...
                              <?php
                              $query1  = "SELECT emp_id, fname,lname from employee where emp_type='Casual'";
